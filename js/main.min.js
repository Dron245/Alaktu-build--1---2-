...
!function (e, t) {
  ...
  var z = function z(e, t) {
      ...
      var s = t.closest(e.isElement ? "swiper-slide" : "." + e.params.slideClass);
      if (s) {
        var _t2 = s.querySelector("." + e.params.lazyPreloaderClass);
        _t2 && _t2.remove();
      }
    },
    A = function A(e, t) {
    ...
    I = function I(e) {
      ...
      if (e.params.rewind) for (var _a3 = i - t; _a3 <= r + t; _a3 += 1) {
        var _t3 = (_a3 % s + s) % s;
        _t3 !== i && _t3 > r && A(e, _t3);
      } else for (var _a4 = Math.max(r - t, 0); _a4 <= Math.min(r + t, s - 1); _a4 += 1) _a4 !== i && _a4 > r && A(e, _a4);
    };
  function k(e) {
    var t = e.swiper,
      s = e.runCallbacks,
  ...
  function O(e) {
    ...
    var f = o.noSwipingSelector ? o.noSwipingSelector : "." + o.noSwipingClass,
  ...
  function D(e) {
    ...
    if (void 0 === i.isScrolling) {
      var _e2;
      s.isHorizontal() && n.currentY === n.startY || s.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : f * f + g * g >= 25 && (_e2 = 180 * Math.atan2(Math.abs(g), Math.abs(f)) / Math.PI, i.isScrolling = s.isHorizontal() ? _e2 > r.touchAngle : 90 - _e2 > r.touchAngle);
    }
  ...
  function G(e) {
    ...
    if (t.allowClick) {
      var _e4 = p.path || p.composedPath && p.composedPath();
      t.updateClickedSlide(_e4 && _e4[0] || p.target), t.emit("tap click", p), m < 300 && u - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", p);
    }
    ...
    for (var _e5 = 0; _e5 < d.length; _e5 += _e5 < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
      var _t4 = _e5 < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
      void 0 !== d[_e5 + _t4] ? h >= d[_e5] && h < d[_e5 + _t4] && (f = _e5, g = d[_e5 + _t4] - d[_e5]) : h >= d[_e5] && (f = _e5, g = d[d.length - 1] - d[d.length - 2]);
    }
    var v = null,
      w = null;
  ...
  var V = {
      ...
      update: {
        ...
        updateSlides: function updateSlides() {
            ...
            if (z = 0, p[_i3] && (_r2 = p[_i3]), L && e.grid.updateSlide(_i3, _r2, m, t), !p[_i3] || "none" !== w(_r2, "display")) {
              if ("auto" === a.slidesPerView) {
                ...
                if (_l && (_r2.style.transform = "none"), _o && (_r2.style.webkitTransform = "none"), a.roundLengths) z = e.isHorizontal() ? x(_r2, "width", !0) : x(_r2, "height", !0);else {
                  var _e6 = s(_n, "width"),
                    _t5 = s(_n, "padding-left"),
                    _a5 = s(_n, "padding-right"),
                    _i4 = s(_n, "margin-left"),
                    _l2 = s(_n, "margin-right"),
                    _o2 = _n.getPropertyValue("box-sizing");
                  if (_o2 && "border-box" === _o2) z = _e6 + _i4 + _l2;else {
                    var _r3 = _r2,
                      _s4 = _r3.clientWidth,
                      _n2 = _r3.offsetWidth;
                    z = _e6 + _t5 + _a5 + _i4 + _l2 + (_n2 - _s4);
                  }
                }
                _l && (_r2.style.transform = _l), _o && (_r2.style.webkitTransform = _o), a.roundLengths && (z = Math.floor(z));
              } else z = (n - (a.slidesPerView - 1) * T) / a.slidesPerView, a.roundLengths && (z = Math.floor(z)), p[_i3] && (p[_i3].style[t("width")] = z + "px");
          ...
          if (e.virtualSize = Math.max(e.virtualSize, n) + y, l && o && ("slide" === a.effect || "coverflow" === a.effect) && (i.style.width = e.virtualSize + T + "px"), a.setWrapperSize && (i.style[t("width")] = e.virtualSize + T + "px"), L && e.grid.updateWrapperSize(z, h, t), !a.centeredSlides) {
            ...
            for (var _s5 = 0; _s5 < h.length; _s5 += 1) {
              var _i5 = h[_s5];
              a.roundLengths && (_i5 = Math.floor(_i5)), h[_s5] <= e.virtualSize - n && _t6.push(_i5);
            }
            h = _t6, Math.floor(e.virtualSize - n) - Math.floor(h[h.length - 1]) > 1 && h.push(e.virtualSize - n);
          }
          if (d && a.loop) {
            var _t7 = v[0] + T;
            if (a.slidesPerGroup > 1) {
              var _s6 = Math.ceil((e.virtual.slidesBefore + e.virtual.slidesAfter) / a.slidesPerGroup),
                _i6 = _t7 * a.slidesPerGroup;
              for (var _e7 = 0; _e7 < _s6; _e7 += 1) h.push(h[h.length - 1] + _i6);
            }
            for (var _s7 = 0; _s7 < e.virtual.slidesBefore + e.virtual.slidesAfter; _s7 += 1) 1 === a.slidesPerGroup && h.push(h[h.length - 1] + _t7), g.push(g[g.length - 1] + _t7), e.virtualSize += _t7;
          }
          ...
          if (m !== c && e.emit("slidesLengthChange"), h.length !== E && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), g.length !== S && e.emit("slidesGridLengthChange"), a.watchSlidesProgress && e.updateSlidesOffset(), !(d || a.cssMode || "slide" !== a.effect && "fade" !== a.effect)) {
            var _t11 = a.containerModifierClass + "backface-hidden",
              _s10 = e.el.classList.contains(_t11);
            m <= a.maxBackfaceHiddenSlides ? _s10 || e.el.classList.add(_t11) : _s10 && e.el.classList.remove(_t11);
          }
        },
        updateAutoHeight: function updateAutoHeight(e) {
          ...
          if ("auto" !== t.params.slidesPerView && t.params.slidesPerView > 1) {
            if (t.params.centeredSlides) (t.visibleSlides || []).forEach(function (e) {
              ...
              if (_e10 > t.slides.length && !a) break;
              s.push(n(_e10));
            }
          } else s.push(n(t.activeIndex));
          for (i = 0; i < s.length; i += 1) if (void 0 !== s[i]) {
            var _e11 = s[i].offsetHeight;
            r = _e11 > r ? _e11 : r;
          }
        ...
        updateSlidesProgress: function updateSlidesProgress(e) {
          ...
          for (var _e12 = 0; _e12 < a.length; _e12 += 1) {
            var _o3 = a[_e12];
            ...
            var _c = (n + (s.centeredSlides ? t.minTranslate() : 0) - _d) / (_o3.swiperSlideSize + l),
              ...
              _u = -(n - _d),
              _m = _u + t.slidesSizesGrid[_e12];
            (_u >= 0 && _u < t.size - 1 || _m > 1 && _m <= t.size || _u <= 0 && _m >= t.size) && (t.visibleSlides.push(_o3), t.visibleSlidesIndexes.push(_e12), a[_e12].classList.add(s.slideVisibleClass)), _o3.progress = i ? -_c : _c, _o3.originalProgress = i ? -_p : _p;
          }
        },
        ...
        updateSlidesClasses: function updateSlidesClasses() {
          ...
          if (t.forEach(function (e) {
            ...
            if (s.loop) {
              ...
              _t12 < 0 && (_t12 = e.virtual.slides.length + _t12), _t12 >= e.virtual.slides.length && (_t12 -= e.virtual.slides.length), l = n("[data-swiper-slide-index=\"".concat(_t12, "\"]"));
          ...
          if (l) {
            ...
            s.loop && !_e13 && (_e13 = t[0]), _e13 && _e13.classList.add(s.slideNextClass);
        ...
        updateActiveIndex: function updateActiveIndex(e) {
          ...
          if (void 0 === d && (d = function (e) {
            ...
            var i;
            for (var _e14 = 0; _e14 < t.length; _e14 += 1) void 0 !== t[_e14 + 1] ? a >= t[_e14] && a < t[_e14 + 1] - (t[_e14 + 1] - t[_e14]) / 2 ? i = _e14 : a >= t[_e14] && a < t[_e14 + 1] && (i = _e14 + 1) : a >= t[_e14] && (i = _e14);
            return s.normalizeSlideIndex && (i < 0 || void 0 === i) && (i = 0), i;
          }(t)), a.indexOf(s) >= 0) o = a.indexOf(s);else {
            var _e15 = Math.min(i.slidesPerGroupSkip, d);
            o = _e15 + Math.floor((d - _e15) / i.slidesPerGroup);
          }
        ...
        updateClickedSlide: function updateClickedSlide(e) {
          ...
          var i,
            r = !1;
          if (a) for (var _e16 = 0; _e16 < t.slides.length; _e16 += 1) if (t.slides[_e16] === a) {
            r = !0, i = _e16;
            break;
          }
      ...
      translate: {
        ...
        translateTo: function translateTo(e, t, s, a, i) {
          ...
          if (c = a && e > o ? o : a && e < d ? d : e, r.updateProgress(c), n.cssMode) {
            ...
            if (0 === t) l[_e17 ? "scrollLeft" : "scrollTop"] = -c;else {
              if (!r.support.smoothScroll) return m({
                swiper: r,
                targetPosition: -c,
                side: _e17 ? "left" : "top"
              }), !0;
              l.scrollTo(_defineProperty(_defineProperty({}, _e17 ? "left" : "top", -c), "behavior", "smooth"));
            }
            return !0;
          }
      ...
      slide: {
        slideTo: function slideTo(e, t, s, a, i) {
          ...
          var w = -o[v];
          if (l.normalizeSlideIndex) for (var _e18 = 0; _e18 < d.length; _e18 += 1) {
            var _t13 = -Math.floor(100 * w),
              _s14 = Math.floor(100 * d[_e18]),
              _a11 = Math.floor(100 * d[_e18 + 1]);
            void 0 !== d[_e18 + 1] ? _t13 >= _s14 && _t13 < _a11 - (_a11 - _s14) / 2 ? n = _e18 : _t13 >= _s14 && _t13 < _a11 && (n = _e18 + 1) : _t13 >= _s14 && (n = _e18);
          }
          ...
          if (l.cssMode) {
            ...
            if (0 === t) {
              ...
              _t14 && (r.wrapperEl.style.scrollSnapType = "none", r._immediateVirtual = !0), _t14 && !r._cssModeVirtualInitialSet && r.params.initialSlide > 0 ? (r._cssModeVirtualInitialSet = !0, requestAnimationFrame(function () {
                h[_e19 ? "scrollLeft" : "scrollTop"] = _s15;
              })) : h[_e19 ? "scrollLeft" : "scrollTop"] = _s15, _t14 && requestAnimationFrame(function () {
              ...
              h.scrollTo(_defineProperty(_defineProperty({}, _e19 ? "left" : "top", _s15), "behavior", "smooth"));
            }
            return !0;
          }
      ...
      loop: {
        loopCreate: function loopCreate(e) {
          var t = this,
            s = t.params,
            a = t.slidesEl;
          !s.loop || t.virtual && t.params.virtual.enabled || (f(a, ".".concat(s.slideClass, ", swiper-slide")).forEach(function (e, t) {
        ...
        loopFix: function loopFix(e) {
          ...
          if (r < f) {
            ...
            for (var _e23 = 0; _e23 < f - r; _e23 += 1) {
              var _t15 = _e23 - Math.floor(_e23 / d.length) * d.length;
              g.push(d.length - _t15 - 1);
            }
          } else if (r > o.slides.length - 2 * f) {
            x = Math.max(r - (o.slides.length - 2 * f), m.slidesPerGroup);
            for (var _e24 = 0; _e24 < x; _e24 += 1) {
              var _t16 = _e24 - Math.floor(_e24 / d.length) * d.length;
              v.push(_t16);
            }
          }
          if (y && g.forEach(function (e) {
            ...
            if (void 0 === t) {
              var _e25 = o.slidesGrid[w],
                _t17 = o.slidesGrid[w + E] - _e25;
            ...
            var _e26 = o.slidesGrid[w],
              _t18 = o.slidesGrid[w - x] - _e26;
            l ? o.setTranslate(o.translate - _t18) : (o.slideTo(w - x, 0, !1, !0), i && (o.touches[o.isHorizontal() ? "startX" : "startY"] += _t18));
          ...
          if (o.allowSlidePrev = c, o.allowSlideNext = p, o.controller && o.controller.control && !n) {
            ...
            Array.isArray(o.controller.control) ? o.controller.control.forEach(function (t) {
              !t.destroyed && t.params.loop && t.loopFix(_e27);
            }) : o.controller.control instanceof o.constructor && o.controller.control.params.loop && o.controller.control.loopFix(_e27);
          }
          o.emit("loopFix");
        },
      ...
      events: {
        attachEvents: function attachEvents() {
          var e = this,
            t = a(),
            s = e.params;
          e.onTouchStart = O.bind(e), e.onTouchMove = D.bind(e), e.onTouchEnd = G.bind(e), s.cssMode && (e.onScroll = X.bind(e)), e.onClick = H.bind(e), e.onLoad = Y.bind(e), B || (t.addEventListener("touchstart", N), B = !0), q(e, "on");
        },
  ...
  var W = /*#__PURE__*/function () {
    ...
    _createClass(W, [{
      ...
      value: function slidesPerViewDynamic(e, t) {
        ...
        } else if ("current" === e) for (var _e31 = l + 1; _e31 < a.length; _e31 += 1) (t ? i[_e31] + r[_e31] - i[l] < n : i[_e31] - i[l] < n) && (o += 1);else for (var _e32 = l - 1; _e32 >= 0; _e32 -= 1) i[l] - i[_e32] < n && (o += 1);
        return o;
      }
    }, {
      key: "update",
      ...
      value: function mount(e) {
        ...
        var i = s && s.shadowRoot && s.shadowRoot.querySelector ? s.shadowRoot.querySelector(a()) : f(s, a())[0];
        return !i && t.params.createElements && (i = g("div", t.params.wrapperClass), s.append(i), f(s, "." + t.params.slideClass).forEach(function (e) {
          i.append(e);
        })), Object.assign(t, {
          el: s,
          wrapperEl: i,
  ...
  function se(e) {
    ...
    a("beforeInit", function () {
      ...
      s.classNames.push("".concat(s.params.containerModifierClass).concat(t)), l && l() && s.classNames.push(s.params.containerModifierClass + "3d");
      var e = n ? n() : {};
  ...
  var ne = [function (e) {
    ...
    function d(e) {
      ...
      if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || l.activeElement && l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase()))) {
        if (t.params.keyboard.onlyInViewport && (d || c || p || u || m || h)) {
          var _e41 = !1;
          if (y(t.el, ".".concat(t.params.slideClass, ", swiper-slide")).length > 0 && 0 === y(t.el, "." + t.params.slideActiveClass).length) return;
          var _a13 = t.el,
    ...
    function p(e) {
      var s = e.target.closest(K(t.params.pagination.bulletClass));
      if (!s) return;
      e.preventDefault();
    ...
    function u() {
      ...
      if (t.params.loop ? (r = t.previousRealIndex || 0, a = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (a = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, a = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
        ...
        if (s.dynamicBullets && (n = x(_i12[0], t.isHorizontal() ? "width" : "height", !0), p.forEach(function (e) {
          ...
          var t = b(e);
          t === a && (_e$classList5 = e.classList).add.apply(_e$classList5, _toConsumableArray(s.bulletActiveClass.split(" "))), s.dynamicBullets && (t >= _o6 && t <= _d3 && (_e$classList6 = e.classList).add.apply(_e$classList6, _toConsumableArray((s.bulletActiveClass + "-main").split(" "))), t === _o6 && c(e, "prev"), t === _d3 && c(e, "next"));
        });else {
          var _e45$classList;
          var _e45 = _i12[a];
          if (_e45 && (_e45$classList = _e45.classList).add.apply(_e45$classList, _toConsumableArray(s.bulletActiveClass.split(" "))), s.dynamicBullets) {
            ...
            for (var _e47 = _o6; _e47 <= _d3; _e47 += 1) {
              ...
              _i12[_e47] && (_i12$_e47$classList = _i12[_e47].classList).add.apply(_i12$_e47$classList, _toConsumableArray((s.bulletActiveClass + "-main").split(" ")));
            }
        ...
        if (s.dynamicBullets) {
          ...
          _i12.forEach(function (e) {
            e.style[t.isHorizontal() ? _l6 : "top"] = _r8 + "px";
          });
        }
      }
      p.forEach(function (e, r) {
        if ("fraction" === s.type && (e.querySelectorAll(K(s.currentClass)).forEach(function (e) {
          e.textContent = s.formatFractionCurrent(a + 1);
        }), e.querySelectorAll(K(s.totalClass)).forEach(function (e) {
          ...
          var _n6 = 1,
            _l7 = 1;
          "horizontal" === _i13 ? _n6 = _r9 : _l7 = _r9, e.querySelectorAll(K(s.progressbarFillClass)).forEach(function (e) {
            e.style.transform = "translate3d(0,0,0) scaleX(".concat(_n6, ") scaleY(").concat(_l7, ")"), e.style.transitionDuration = t.params.speed + "ms";
          });
        }
    ...
    function m() {
      ...
      "fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : "<span class=\"".concat(e.currentClass, "\"></span> / <span class=\"").concat(e.totalClass, "\"></span>")), "progressbar" === e.type && (r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : "<span class=\"".concat(e.progressbarFillClass, "\"></span>")), t.pagination.bullets = [], a.forEach(function (s) {
        ...
        "custom" !== e.type && (s.innerHTML = r || ""), "bullets" === e.type && (_t$pagination$bullets = t.pagination.bullets).push.apply(_t$pagination$bullets, _toConsumableArray(s.querySelectorAll(K(e.bulletClass))));
    ...
    function f() {
      ...
      var l = d,
        o = (c - d) * n;
      s ? (o = -o, o > 0 ? (l = d - o, o = 0) : -o + d > c && (l = c + o)) : o < 0 ? (l = d + o, o = 0) : o + d > c && (l = c - o), t.isHorizontal() ? (a.style.transform = "translate3d(".concat(o, "px, 0, 0)"), a.style.width = l + "px") : (a.style.transform = "translate3d(0px, ".concat(o, "px, 0)"), a.style.height = l + "px"), r.hide && (clearTimeout(m), i.style.opacity = 1, m = setTimeout(function () {
    ...
    var i = function i(e, s) {
        ...
        null != o && (p += " scale(".concat(o - (o - 1) * (1 - Math.abs(s)), ")")), c && null != c && (p += " rotate(".concat(c * s * -1, "deg)")), e.style.transform = p;
      },
      r = function r() {
        var e = t.el,
          s = t.slides,
    ...
    function x(e) {
      ...
      if (l = !1, d = !1, u.push(e), !(u.length < 2)) {
        if (l = !0, m.scaleStart = b(), !m.slideEl) {
          ...
          var _a19 = m.slideEl.querySelector("." + s.containerClass);
          if (_a19 && (_a19 = _a19.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), m.imageEl = _a19, m.imageWrapEl = _a19 ? y(m.imageEl, "." + s.containerClass)[0] : void 0, !m.imageWrapEl) return void (m.imageEl = void 0);
    ...
    function T(e) {
      ...
      i >= 0 && u.splice(i, 1), l && d && (l = !1, d = !1, m.imageEl && (a.scale = Math.max(Math.min(a.scale, m.maxRatio), s.minRatio), m.imageEl.style.transitionDuration = t.params.speed + "ms", m.imageEl.style.transform = "translate3d(0,0,0) scale(".concat(a.scale, ")"), c = a.scale, p = !1, a.scale > 1 && m.slideEl ? m.slideEl.classList.add("" + s.zoomedSlideClass) : a.scale <= 1 && m.slideEl && m.slideEl.classList.remove("" + s.zoomedSlideClass), 1 === a.scale && (m.originX = 0, m.originY = 0, m.slideEl = void 0)));
    }
    function M(e) {
      if (!E(e) || !function (e) {
        var s = "." + t.params.zoom.containerClass;
    ...
    function P(e) {
      var s = t.zoom,
        a = t.params.zoom;
      if (!m.slideEl) {
        e && e.target && (m.slideEl = e.target.closest(".".concat(t.params.slideClass, ", swiper-slide"))), m.slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? m.slideEl = f(t.slidesEl, "." + t.params.slideActiveClass)[0] : m.slideEl = t.slides[t.activeIndex]);
        var _s29 = m.slideEl.querySelector("." + a.containerClass);
        _s29 && (_s29 = _s29.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), m.imageEl = _s29, m.imageWrapEl = _s29 ? y(m.imageEl, "." + a.containerClass)[0] : void 0;
      }
    ...
    function L() {
      ...
      if (!m.slideEl) {
        ...
        var _e50 = m.slideEl.querySelector("." + s.containerClass);
        _e50 && (_e50 = _e50.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), m.imageEl = _e50, m.imageWrapEl = _e50 ? y(m.imageEl, "." + s.containerClass)[0] : void 0;
      }
    ...
    a("beforeInit", function () {
      ...
      t.params.a11y.enabled && function () {
        ...
        var a = t.wrapperEl,
          r = e.id || a.getAttribute("id") || "swiper-wrapper-" + (void 0 === (l = 16) && (l = 16), "x".repeat(l).replace(/x/g, function () {
        ...
        var _ref5 = t.navigation ? t.navigation : {},
          u = _ref5.nextEl,
          m = _ref5.prevEl;
        u = n(u), m = n(m), u && u.forEach(function (t) {
      ...
      t.params.a11y.enabled && function () {
        ...
        f() && t.pagination.bullets.forEach(function (s) {
          t.params.pagination.clickable && (l(s), t.params.pagination.renderBullet || (d(s, "button"), p(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, b(s) + 1)))), s.matches(K(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current");
        });
      }();
    }), a("destroy", function () {
      t.params.a11y.enabled && function () {
    ...
    var l = function l(e) {
      ...
      d = function d(e, s) {
        ...
        if (t.params.history.root.length > 0) {
          ...
          "/" === _s32[_s32.length - 1] && (_s32 = _s32.slice(0, _s32.length - 1)), d = "".concat(_s32, "/").concat(e ? e + "/" : "").concat(d);
        } else n.pathname.includes(e) || (d = "".concat(e ? e + "/" : "").concat(d));
      ...
      hashNavigation: {
        ...
        getSlideIndex: function getSlideIndex(e, s) {
          if (t.virtual && t.params.virtual.enabled) {
            ...
            return _e53 ? parseInt(_e53.getAttribute("data-swiper-slide-index"), 10) : 0;
          }
    ...
    t.thumbs = {
      ...
      if (e && e.swiper) if ("string" == typeof e.swiper || e.swiper instanceof HTMLElement) {
        var _s36 = a(),
          ...
          _r13 = function _r13() {
            t.destroyed || _i16() || requestAnimationFrame(_r13);
          };
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _s42 = 0; _s42 < e.length; _s42 += 1) {
          ...
          var _r14 = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(_e61.progress), 0) : 1 + Math.min(Math.max(_e61.progress, -1), 0),
            _n7 = ae(0, _e61);
          _n7.style.opacity = _r14, _n7.style.transform = "translate3d(".concat(_a26, "px, ").concat(_i19, "px, 0px)");
        }
      },
    ...
    se({
      ...
      setTranslate: function setTranslate() {
        ...
        s.style.transform = "translate3d(0px,0,".concat(f, "px) rotateX(").concat(t.isHorizontal() ? 0 : h, "deg) rotateY(").concat(t.isHorizontal() ? -h : 0, "deg)"), s.style.setProperty("--swiper-cube-translate-z", f + "px");
      },
      setTransition: function setTransition(e) {
        var s = t.el,
          a = t.slides;
        if (a.forEach(function (t) {
          ...
          _t46 && (_t46.style.transitionDuration = e + "ms");
        }
      },
    ...
    var i = function i(e, s, a) {
      ...
      i || (i = re(0, e, t.isHorizontal() ? "left" : "top")), r || (r = re(0, e, t.isHorizontal() ? "right" : "bottom")), i && (i.style.opacity = Math.max(-s, 0)), r && (r.style.opacity = Math.max(s, 0));
    };
    se({
      effect: "flip",
      swiper: t,
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e64 = 0, _t47 = a.length; _e64 < _t47; _e64 += 1) {
          ...
          if (ae(0, _t48).style.transform = _b, _t48.style.zIndex = 1 - Math.abs(Math.round(_p5)), r.slideShadows) {
            ...
            _e65 || (_e65 = re(0, _t48, n ? "left" : "top")), _s46 || (_s46 = re(0, _t48, n ? "right" : "bottom")), _e65 && (_e65.style.opacity = _p5 > 0 ? _p5 : 0), _s46 && (_s46.style.opacity = -_p5 > 0 ? -_p5 : 0);
          }
        }
      },
      setTransition: function setTransition(e) {
      ...
      setTranslate: function setTranslate() {
        ...
        var _loop = function _loop() {
          ...
          if (h && f.shadow || !h) {
            ...
            if (!_e67 && f.shadow && (_e67 = re(0, a)), _e67) {
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _l10 = 0; _l10 < e.length; _l10 += 1) {
          ...
          if (_b2 || _y) {
            ...
            _g3 += -28 * _c4 * _e68, _f4 += -.5 * _e68, _v3 += 96 * _e68, _m6 = -25 * _e68 * Math.abs(_c4) + "%";
          }
          if (_u6 = _c4 < 0 ? "calc(".concat(_u6, "px + (").concat(_v3 * Math.abs(_c4), "%))") : _c4 > 0 ? "calc(".concat(_u6, "px + (-").concat(_v3 * Math.abs(_c4), "%))") : _u6 + "px", !t.isHorizontal()) {
            var _e69 = _m6;
            _m6 = _u6, _u6 = _e69;
          }
          ...
          if (a.slideShadows) {
            ...
            _e70 || (_e70 = re(0, _o9)), _e70 && (_e70.style.opacity = Math.min(Math.max((Math.abs(_c4) - .5) / .5, 0), 1));
          }
          _o9.style.zIndex = -Math.abs(Math.round(_d6)) + e.length, ae(0, _o9).style.transform = _x;
        }
      },
      setTransition: function setTransition(e) {
        var s = t.slides.map(function (e) {
 ...
 */
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Viewer = e();
}(void 0, function () {
  "use strict";
  ...
  function e(e) {
    for (var i = 1; i < arguments.length; i++) {
      ...
      i % 2 ? t(Object(n), !0).forEach(function (t) {
        var i, s;
        i = e, s = n[t = t], (t = o(t)) in i ? Object.defineProperty(i, t, {
          value: s,
          enumerable: !0,
          configurable: !0,
          writable: !0
  ...
  function o(t) {
    return "symbol" == _typeof(t = function (t, e) {
      if ("object" != _typeof(t) || null === t) return t;
      var i = t[Symbol.toPrimitive];
      if (void 0 === i) return String(t);
      if ("object" != _typeof(i = i.call(t, e))) return i;
  ...
  var s = {
    ...
    a = (Tt = "undefined" != typeof window && void 0 !== window.document) ? window : {},
    r = !(!Tt || !a.document.documentElement) && "ontouchstart" in a.document.documentElement,
    l = Tt && "PointerEvent" in a,
    h = "viewer",
    c = "move",
    u = "switch",
    d = "zoom",
    ...
    f = "".concat(h, "-fade"),
    v = "".concat(h, "-fixed"),
    p = "".concat(h, "-fullscreen"),
    b = "".concat(h, "-fullscreen-exit"),
    w = "".concat(h, "-hide"),
    y = "".concat(h, "-hide-md-down"),
    x = "".concat(h, "-hide-sm-down"),
    k = "".concat(h, "-hide-xs-down"),
    z = "".concat(h, "-in"),
    ...
    F = "load",
    N = "error",
    Y = l ? "pointerdown" : r ? "touchstart" : "mousedown",
    X = l ? "pointermove" : r ? "touchmove" : "mousemove",
    P = l ? "pointerup pointercancel" : r ? "touchend touchcancel" : "mouseup",
    q = "transitionend",
    W = "viewed",
    j = "rotated",
    H = "".concat(h, "Action"),
  ...
  function J(t) {
    ...
    try {
      var e = t.constructor,
        i = e.prototype;
      return e && i && G.call(i, "isPrototypeOf");
    } catch (t) {
      return !1;
    }
  }
  ...
  function tt(t, e) {
    if (t && Q(e)) if (Array.isArray(t) || Z(t.length)) for (var i = t.length, n = 0; n < i && !1 !== e.call(t, t[n], n, t); n += 1);else _(t) && Object.keys(t).forEach(function (i) {
      e.call(t, t[i], i, t);
    });
  }
  var et = Object.assign || function (t) {
      for (var e = arguments.length, i = new Array(1 < e ? e - 1 : 0), n = 1; n < e; n++) i[n - 1] = arguments[n];
      return _(t) && 0 < i.length && i.forEach(function (e) {
        _(e) && Object.keys(e).forEach(function (i) {
          t[i] = e[i];
        });
      }), t;
    },
    it = /^(?:width|height|left|top|marginLeft|marginTop)$/;
  function nt(t, e) {
    var i = t.style;
    tt(e, function (t, e) {
      it.test(e) && Z(t) && (t += "px"), i[e] = t;
    });
  }
  function ot(t, e) {
  ...
  function st(t, e) {
    var i;
    t && e && (Z(t.length) ? tt(t, function (t) {
      st(t, e);
  ...
  function ct(t, e) {
    return _(t[e]) ? t[e] : t.dataset ? t.dataset[e] : t.getAttribute("data-".concat(ht(e)));
  }
  function ut(t, e, i) {
    _(i) ? t[e] = i : t.dataset ? t.dataset[e] = i : t.setAttribute("data-".concat(ht(e)), i);
  }
  mt = !1, Tt && (dt = !1, l = function l() {}, Tt = Object.defineProperty({}, "once", {
    get: function get() {
      return mt = !0, dt;
    },
    set: function set(t) {
  ...
  }), a.addEventListener("test", l, Tt), a.removeEventListener("test", l, Tt));
  var dt,
    mt,
    gt = mt;
  function ft(t, e, i, n) {
    var o = 3 < arguments.length && void 0 !== n ? n : {},
      s = i;
    e.trim().split(B).forEach(function (e) {
      var n;
      gt || (n = t.listeners) && n[e] && n[e][i] && (s = n[e][i], delete n[e][i], 0 === Object.keys(n[e]).length && delete n[e], 0 === Object.keys(n).length) && delete t.listeners, t.removeEventListener(e, s, o);
    });
  }
  function vt(t, e, i, n) {
    var o = 3 < arguments.length && void 0 !== n ? n : {},
    ...
    e.trim().split(B).forEach(function (e) {
      var n, a;
      o.once && !gt && (n = t.listeners, _s = function s() {
        delete a[e][i], t.removeEventListener(e, _s, o);
        for (var n = arguments.length, r = new Array(n), l = 0; l < n; l++) r[l] = arguments[l];
        i.apply(t, r);
      }, (a = void 0 === n ? {} : n)[e] || (a[e] = {}), a[e][i] && t.removeEventListener(e, a[e][i], o), a[e][i] = _s, t.listeners = a), t.addEventListener(e, _s, o);
    });
  }
  function pt(t, i, n, o) {
    var s;
    return Q(Event) && Q(CustomEvent) ? s = new CustomEvent(i, e({
      bubbles: !0,
      cancelable: !0,
      detail: n
    }, o)) : (s = document.createEvent("CustomEvent")).initCustomEvent(i, !0, !0, n), t.dispatchEvent(s);
  }
  function bt(t) {
    var e = t.rotate,
      i = t.scaleX,
      ...
      s = (t = t.translateY, []);
    return {
      WebkitTransform: o = (Z(o) && 0 !== o && s.push("translateX(".concat(o, "px)")), Z(t) && 0 !== t && s.push("translateY(".concat(t, "px)")), Z(e) && 0 !== e && s.push("rotate(".concat(e, "deg)")), Z(i) && 1 !== i && s.push("scaleX(".concat(i, ")")), Z(n) && 1 !== n && s.push("scaleY(".concat(n, ")")), s.length ? s.join(" ") : "none"),
      msTransform: o,
      transform: o
    };
  }
  var wt = a.navigator && /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(a.navigator.userAgent);
  function yt(t, e, i) {
    var n,
      o = document.createElement("img");
    return t.naturalWidth && !wt ? i(t.naturalWidth, t.naturalHeight) : (n = document.body || document.documentElement, o.onload = function () {
      i(o.width, o.height), wt || n.removeChild(o);
    }, tt(e.inheritedAttributes, function (e) {
      var i = t.getAttribute(e);
      null !== i && o.setAttribute(e, i);
    }), o.src = t.src, wt || (o.style.cssText = "left:0;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;opacity:0;position:absolute;top:0;z-index:-1;", n.appendChild(o))), o;
  }
  function xt(t) {
    switch (t) {
      case 2:
  ...
  l = {
    ...
    initViewer: function initViewer() {
      ...
      }, this.parentData = t), !this.fulled && t || (t = this.containerData), this.viewerData = et({}, t);
    },
    ...
    initList: function initList() {
      var t = this,
        ...
        n = this.list,
        o = [];
      n.innerHTML = "", tt(this.images, function (e, s) {
        var a,
          r,
          l = e.src,
          h = e.alt || (U(h = l) ? decodeURIComponent(h.replace(/^.*\//, "").replace(/[?&#].*$/, "")) : ""),
          c = t.getImageURL(e);
        (l || c) && (a = document.createElement("li"), r = document.createElement("img"), tt(i.inheritedAttributes, function (t) {
          var i = e.getAttribute(t);
          null !== i && r.setAttribute(t, i);
        }), i.navbar && (r.src = l || c), r.alt = h, r.setAttribute("data-original-url", c || l), a.setAttribute("data-index", s), a.setAttribute("data-viewer-action", "view"), a.setAttribute("role", "button"), i.keyboard && a.setAttribute("tabindex", 0), a.appendChild(r), n.appendChild(a), o.push(a));
      }), tt(this.items = o, function (e) {
        var n,
          o,
          s = e.firstElementChild;
        ut(s, "filled", !0), i.loading && st(e, E), vt(s, F, n = function n(_n) {
          ft(s, N, o), i.loading && at(e, E), t.loadImage(_n);
        }, {
          once: !0
        }), vt(s, N, o = function o() {
          ft(s, F, n), i.loading && at(e, E);
        }, {
          once: !0
        });
      }), i.transition && vt(e, W, function () {
        st(n, A);
      }, {
        once: !0
      });
    ...
    renderList: function renderList() {
      var t,
        ...
        i = this.index,
        n = this.items[i];
      n && (t = n.nextElementSibling, t = parseInt(window.getComputedStyle(t || n).marginLeft, 10), n = n.offsetWidth, nt(this.list, et({
    ...
    resetList: function resetList() {
      var t = this.list;
      t.innerHTML = "", at(t, A), nt(t, bt({
        translateX: 0
      }));
    },
    initImage: function initImage(t) {
      var e,
        i = this,
        n = this.options,
        o = this.image,
        ...
        r = s.width,
        l = Math.max(s.height - a, a),
        h = this.imageData || {};
      this.imageInitializing = {
        abort: function abort() {
          e.onload = null;
        }
      }, e = yt(o, n, function (e, o) {
        var s = e / o,
          a = Math.max(0, Math.min(1, n.initialCoverage)),
          c = r,
          u = l,
          d = (a = (i.imageInitializing = !1, r < l * s ? u = r / s : c = l * s, a = Z(a) ? a : .9, c = Math.min(c * a, e), u = Math.min(u * a, o), (r - c) / 2), et({}, a = {
            left: a,
            top: d = (l - u) / 2,
            x: a,
            y: d,
        ...
        n.rotatable && (a.rotate = h.rotate || 0, d.rotate = 0), n.scalable && (a.scaleX = h.scaleX || 1, a.scaleY = h.scaleY || 1, d.scaleX = 1, d.scaleY = 1), i.imageData = a, i.initialImageData = d, t && t();
      });
    },
    renderImage: function renderImage(t) {
      ...
      nt(n, et({
        ...
        marginLeft: o.x,
        marginTop: o.y
      }, bt(o))), t && ((this.viewing || this.moving || this.rotating || this.scaling || this.zooming) && this.options.transition && ot(n, A) ? (e = function e() {
  ...
  var zt,
    Tt = {
      bind: function bind() {
        ...
        vt(e, O, this.onClick = this.click.bind(this)), vt(e, L, this.onDragStart = this.dragstart.bind(this)), vt(i, Y, this.onPointerDown = this.pointerdown.bind(this)), vt(n, X, this.onPointerMove = this.pointermove.bind(this)), vt(n, P, this.onPointerUp = this.pointerup.bind(this)), vt(n, M, this.onKeyDown = this.keydown.bind(this)), vt(window, "resize", this.onResize = this.resize.bind(this)), t.zoomable && t.zoomOnWheel && vt(e, "wheel", this.onWheel = this.wheel.bind(this), {
          passive: !1,
          capture: !0
        }), t.toggleOnDblclick && vt(i, C, this.onDblclick = this.dblclick.bind(this));
      },
      unbind: function unbind() {
        var t = this.options,
          ...
          i = this.canvas,
          n = this.element.ownerDocument;
        ft(e, O, this.onClick), ft(e, L, this.onDragStart), ft(i, Y, this.onPointerDown), ft(n, X, this.onPointerMove), ft(n, P, this.onPointerUp), ft(n, M, this.onKeyDown), ft(window, "resize", this.onResize), t.zoomable && t.zoomOnWheel && ft(e, "wheel", this.onWheel, {
          passive: !1,
          capture: !0
        }), t.toggleOnDblclick && ft(i, C, this.onDblclick);
      }
    },
    Et = {
      click: function click(t) {
        var e = this.options,
          ...
          n = t.target,
          o = ct(n, H);
        switch (o || "img" !== n.localName || "li" !== n.parentElement.localName || (o = ct(n = n.parentElement, H)), r && t.isTrusted && n === this.canvas && clearTimeout(this.clickCanvasTimeout), o) {
          case "mix":
      ...
      dblclick: function dblclick(t) {
        t.preventDefault(), this.viewed && t.target === this.image && (r && t.isTrusted && clearTimeout(this.doubleClickImageTimeout), this.toggle(t.isTrusted ? t : t.detail && t.detail.originalEvent));
      },
      load: function load() {
        var t = this,
          ...
          o = this.index,
          s = this.viewerData;
        at(n, T), i.loading && at(this.canvas, E), n.style.cssText = "height:0;" + "margin-left:".concat(s.width / 2, "px;") + "margin-top:".concat(s.height / 2, "px;") + "max-width:none!important;position:relative;width:0;", this.initImage(function () {
          rt(n, D, i.movable), rt(n, A, i.transition), t.renderImage(function () {
            t.viewed = !0, t.viewing = !1, Q(i.viewed) && vt(e, W, i.viewed, {
              once: !0
            }), pt(e, W, {
      ...
      loadImage: function loadImage(t) {
        var e = t.target,
          i = (t = e.parentNode).offsetWidth || 30,
          n = t.offsetHeight || 50,
          o = !!ct(e, "filled");
        yt(e, this.options, function (t, s) {
          t /= s, s = i;
          var a = n;
          i < n * t ? o ? s = n * t : a = i / t : o ? a = i / t : s = n * t, nt(e, et({
            width: s,
            height: a
          }, bt({
            translateX: (i - s) / 2,
      ...
      pointerdown: function pointerdown(t) {
        var e = this.options,
          ...
          n = t.buttons,
          o = t.button;
        this.pointerMoved = !1, !this.viewed || this.showing || this.viewing || this.hiding || ("mousedown" === t.type || "pointerdown" === t.type && "mouse" === t.pointerType) && (Z(n) && 1 !== n || Z(o) && 0 !== o || t.ctrlKey) || (t.preventDefault(), t.changedTouches ? tt(t.changedTouches, function (t) {
          i[t.identifier] = kt(t);
        }) : i[t.pointerId || 0] = kt(t), n = !!e.movable && c, e.zoomOnTouch && e.zoomable && 1 < Object.keys(i).length ? n = d : e.slideOnTouch && ("touch" === t.pointerType || "touchstart" === t.type) && this.isSwitchable() && (n = u), !e.transition || n !== c && n !== d || at(this.image, A), this.action = n);
      },
      pointermove: function pointermove(t) {
        var e = this.pointers,
          i = this.action;
        this.viewed && i && (t.preventDefault(), t.changedTouches ? tt(t.changedTouches, function (t) {
          et(e[t.identifier] || {}, kt(t, !0));
        }) : et(e[t.pointerId || 0] || {}, kt(t, !0)), this.change(t));
      },
      ...
      resize: function resize() {
        ...
        this.isShown && !this.hiding && (this.fulled && (this.close(), this.initBody(), this.open()), this.initContainer(), this.initViewer(), this.renderViewer(), this.renderList(), this.viewed && this.initImage(function () {
          t.renderImage();
        }), this.played) && (this.options.fullscreen && this.fulled && !(document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement) ? this.stop() : tt(this.player.getElementsByTagName("img"), function (e) {
          vt(e, F, t.loadImage.bind(t), {
            once: !0
          }), pt(e, F);
        }));
      },
    ...
    Dt = {
      show: function show() {
        var t,
          ...
          n = this.element,
          o = this.options;
        return o.inline || this.showing || this.isShown || this.showing || (this.ready ? (Q(o.show) && vt(n, "show", o.show, {
          once: !0
        }), !1 !== pt(n, "show") && this.ready && (this.hiding && this.transitioning.abort(), this.showing = !0, this.open(), at(t = this.viewer, w), t.setAttribute("role", "dialog"), t.setAttribute("aria-labelledby", this.title.id), t.setAttribute("aria-modal", !0), t.removeAttribute("aria-hidden"), o.transition && !i ? (e = this.shown.bind(this), this.transitioning = {
          abort: function abort() {
            ft(t, q, e), at(t, z);
          }
        }, st(t, A), t.initialOffsetWidth = t.offsetWidth, vt(t, q, e, {
          once: !0
        }), st(t, z)) : (st(t, z), this.shown()))) : (this.build(), this.ready && this.show(i))), this;
      },
      hide: function hide() {
        var t,
          e,
          ...
          r = this.element,
          l = this.options;
        return l.inline || this.hiding || !this.isShown && !this.showing || (Q(l.hide) && vt(r, "hide", l.hide, {
          once: !0
        }), !1 !== pt(r, "hide") && (this.showing && this.transitioning.abort(), this.hiding = !0, this.played ? this.stop() : this.viewing && this.viewing.abort(), t = this.viewer, e = this.image, i = function i() {
          at(t, z), s.hidden();
        }, l.transition && !a ? (n = function e(i) {
          i && i.target === t && (ft(t, q, e), s.hidden());
        }, o = function o() {
          ot(t, A) ? (vt(t, q, n), at(t, z)) : i();
        }, this.transitioning = {
          abort: function abort() {
            s.viewed && ot(e, A) ? ft(e, q, o) : ot(t, A) && ft(t, q, n);
          }
        }, this.viewed && ot(e, A) ? (vt(e, q, o, {
          once: !0
        }), this.zoomTo(0, !1, null, null, !0)) : o()) : i())), this;
      },
      view: function view() {
        var t = this,
          e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : this.options.initialViewIndex;
        e = Number(e) || 0;
        if (!(this.hiding || this.played || e < 0 || e >= this.length || this.viewed && e === this.index)) {
          ...
          tt(a.inheritedAttributes, function (t) {
            var e = c.getAttribute(t);
            null !== e && g.setAttribute(t, e);
          }), g.src = u, g.alt = d, Q(a.view) && vt(s, "view", a.view, {
            once: !0
          }), !1 === pt(s, "view", {
            originalImage: this.images[e],
            index: e,
            image: g
          }) || !this.isShown || this.hiding || this.played || ((u = this.items[this.index]) && (at(u, m), u.removeAttribute("aria-selected")), st(h, m), h.setAttribute("aria-selected", !0), a.focus && h.focus(), this.image = g, this.viewed = !1, this.index = e, this.imageData = {}, st(g, T), a.loading && st(l, E), l.innerHTML = "", l.appendChild(g), this.renderList(), r.innerHTML = "", vt(s, W, i = function i() {
            var e = t.imageData,
              i = Array.isArray(a.title) ? a.title[1] : a.title;
            r.innerHTML = U(i = Q(i) ? i.call(t, g, e) : "".concat(d, " (").concat(e.naturalWidth, " × ").concat(e.naturalHeight, ")")) ? i.replace(/&(?!amp;|quot;|#39;|lt;|gt;)/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;") : i;
          }, {
            once: !0
          }), this.viewing = {
            abort: function abort() {
              ft(s, W, i), g.complete ? t.imageRendering ? t.imageRendering.abort() : t.imageInitializing && t.imageInitializing.abort() : (g.src = "", ft(g, F, n), t.timeout && clearTimeout(t.timeout));
            }
          }, g.complete ? this.load() : (vt(g, F, n = function n() {
            ft(g, N, o), t.load();
          }, {
            once: !0
          }), vt(g, N, o = function o() {
            ft(g, F, n), t.timeout && (clearTimeout(t.timeout), t.timeout = !1), at(g, T), a.loading && at(t.canvas, E);
          }, {
            once: !0
      ...
      move: function move(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : t,
          i = this.imageData;
        return this.moveTo($(t) ? t : i.x + Number(t), $(e) ? e : i.y + Number(e)), this;
      },
      moveTo: function moveTo(t) {
        ...
        if (t = Number(t), i = Number(i), this.viewed && !this.played && s.movable) {
          var r = a.x,
            l = a.y,
            h = !1;
          if (Z(t) ? h = !0 : t = r, Z(i) ? h = !0 : i = l, h) {
            if (Q(s.move) && vt(o, "move", s.move, {
              once: !0
            }), !1 === pt(o, "move", {
              x: t,
              y: i,
            ...
            a.x = t, a.y = i, a.left = t, a.top = i, this.moving = !0, this.renderImage(function () {
              e.moving = !1, Q(s.moved) && vt(o, "moved", s.moved, {
                once: !0
              }), pt(o, "moved", {
                x: t,
                y: i,
      ...
      rotateTo: function rotateTo(t) {
        var e = this,
          ...
          n = this.options,
          o = this.imageData;
        if (Z(t = Number(t)) && this.viewed && !this.played && n.rotatable) {
          var s = o.rotate;
          if (Q(n.rotate) && vt(i, "rotate", n.rotate, {
            once: !0
          }), !1 === pt(i, "rotate", {
            degree: t,
            oldDegree: s
          ...
          o.rotate = t, this.rotating = !0, this.renderImage(function () {
            e.rotating = !1, Q(n.rotated) && vt(i, j, n.rotated, {
              once: !0
            }), pt(i, j, {
              degree: t,
              oldDegree: s
      ...
      scale: function scale(t) {
        ...
        if (t = Number(t), i = Number(i), this.viewed && !this.played && o.scalable) {
          var a = s.scaleX,
            r = s.scaleY,
            l = !1;
          if (Z(t) ? l = !0 : t = a, Z(i) ? l = !0 : i = r, l) {
            if (Q(o.scale) && vt(n, "scale", o.scale, {
              once: !0
            }), !1 === pt(n, "scale", {
              scaleX: t,
              scaleY: i,
            ...
            s.scaleX = t, s.scaleY = i, this.scaling = !0, this.renderImage(function () {
              e.scaling = !1, Q(o.scaled) && vt(n, "scaled", o.scaled, {
                once: !0
              }), pt(n, "scaled", {
                scaleX: t,
                scaleY: i,
      ...
      zoomTo: function zoomTo(t) {
        var e,
          ...
          p = d.naturalWidth,
          b = d.naturalHeight;
        if (Z(t = Math.max(0, t)) && this.viewed && !this.played && (l || c.zoomable)) {
          ...
          var w,
            y = b * t,
            x = (p = (l = p * t) - f, b = y - v, d.ratio);
          if (Q(c.zoom) && vt(h, "zoom", c.zoom, {
            once: !0
          }), !1 === pt(h, "zoom", {
            ratio: t,
            oldRatio: x,
          ...
          this.zooming = !0, r ? (w = {
          ...
          }, u = u && 0 < Object.keys(u).length ? (n = i = e = 0, tt(u, function (t) {
            var o = t.startX;
            t = t.startY;
            e += o, i += t, n += 1;
          }), {
            ...
            pageX: r.pageX,
            pageY: r.pageY
          }, d.x -= (u.pageX - w.left - m) / f * p, d.y -= (u.pageY - w.top - g) / v * b) : J(a) && Z(a.x) && Z(a.y) ? (d.x -= p * ((a.x - m) / f), d.y -= b * ((a.y - g) / v)) : (d.x -= p / 2, d.y -= b / 2), d.left = d.x, d.top = d.y, d.width = l, d.height = y, d.oldRatio = x, d.ratio = t, this.renderImage(function () {
            o.zooming = !1, Q(c.zoomed) && vt(h, "zoomed", c.zoomed, {
              once: !0
            }), pt(h, "zoomed", {
              ratio: t,
              oldRatio: x,
      ...
      play: function play() {
        ...
        return this.isShown && !this.played && (t = this.element, Q((e = this.options).play) && vt(t, "play", e.play, {
          once: !0
        }), !1 !== pt(t, "play") && (i = this.player, n = this.loadImage.bind(this), o = [], a = s = 0, this.played = !0, this.onLoadWhenPlay = n, h && this.requestFullscreen(h), st(i, I), tt(this.items, function (t, r) {
          var l = t.querySelector("img"),
            h = document.createElement("img");
          h.src = ct(l, "originalUrl"), h.alt = l.getAttribute("alt"), h.referrerPolicy = l.referrerPolicy, s += 1, st(h, f), rt(h, A, e.transition), ot(t, m) && (st(h, z), a = r), o.push(h), vt(h, F, n, {
            once: !0
          }), i.appendChild(h);
        }), Z(e.interval)) && 0 < e.interval && (r = function t() {
          clearTimeout(l.playing.timeout), at(o[a], z), st(o[a = (a += 1) < s ? a : 0], z), l.playing.timeout = setTimeout(t, e.interval);
        }, 1 < s)) && (this.playing = {
          prev: function t() {
            clearTimeout(l.playing.timeout), at(o[a], z), st(o[a = 0 <= --a ? a : s - 1], z), l.playing.timeout = setTimeout(t, e.interval);
          },
          next: r,
          timeout: setTimeout(r, e.interval)
        }), this;
      },
      stop: function stop() {
        var t,
          e,
          i = this;
        return this.played && (t = this.element, Q((e = this.options).stop) && vt(t, "stop", e.stop, {
          once: !0
        }), !1 !== pt(t, "stop")) && (e = this.player, clearTimeout(this.playing.timeout), this.playing = !1, this.played = !1, tt(e.getElementsByTagName("img"), function (t) {
          ft(t, F, i.onLoadWhenPlay);
        }), at(e, I), e.innerHTML = "", this.exitFullscreen()), this;
      },
      full: function full() {
        var t = this,
          e = this.options,
          ...
          n = this.image,
          o = this.list;
        return this.isShown && !this.played && !this.fulled && e.inline && (this.fulled = !0, this.open(), st(this.button, b), e.transition && (at(o, A), this.viewed) && at(n, A), st(i, v), i.setAttribute("role", "dialog"), i.setAttribute("aria-labelledby", this.title.id), i.setAttribute("aria-modal", !0), i.removeAttribute("style"), nt(i, {
          zIndex: e.zIndex
        }), e.focus && this.enforceFocus(), this.initContainer(), this.viewerData = et({}, this.containerData), this.renderList(), this.viewed) && this.initImage(function () {
      ...
      exit: function exit() {
        var t = this,
          ...
          n = this.image,
          o = this.list;
        return this.isShown && !this.played && this.fulled && e.inline && (this.fulled = !1, this.close(), at(this.button, b), e.transition && (at(o, A), this.viewed) && at(n, A), e.focus && this.clearEnforceFocus(), i.removeAttribute("role"), i.removeAttribute("aria-labelledby"), i.removeAttribute("aria-modal"), at(i, v), nt(i, {
      ...
      tooltip: function tooltip() {
        var t = this,
          ...
          i = this.tooltipBox,
          n = this.imageData;
        return this.viewed && !this.played && e.tooltip && (i.textContent = "".concat(Math.round(100 * n.ratio), "%"), this.tooltipping ? clearTimeout(this.tooltipping) : e.transition ? (this.fading && pt(i, q), st(i, I), st(i, f), st(i, A), i.removeAttribute("aria-hidden"), i.initialOffsetWidth = i.offsetWidth, st(i, z)) : (st(i, I), i.removeAttribute("aria-hidden")), this.tooltipping = setTimeout(function () {
          e.transition ? (vt(i, q, function () {
            at(i, I), at(i, f), at(i, A), i.setAttribute("aria-hidden", !0), t.fading = !1;
          }, {
            once: !0
          }), at(i, z), t.fading = !0) : (at(i, I), i.setAttribute("aria-hidden", !0)), t.tooltipping = !1;
        }, 1e3)), this;
      },
      ...
      reset: function reset() {
        return this.viewed && !this.played && (this.imageData = et({}, this.initialImageData), this.renderImage()), this;
      },
      update: function update() {
        var t,
          ...
          o = this.options,
          s = this.isImg;
        return s && !n.parentNode ? this.destroy() : (t = [], tt(s ? [n] : n.querySelectorAll("img"), function (e) {
          Q(o.filter) ? o.filter.call(i, e) && t.push(e) : i.getImageURL(e) && t.push(e);
        }), t.length && (this.images = t, this.length = t.length, this.ready ? (e = [], tt(this.items, function (i, n) {
          i = i.querySelector("img");
          var o = t[n];
          o && i && o.src === i.src && o.alt === i.alt || e.push(n);
        }), nt(this.list, {
          width: "auto"
        }), this.initList(), this.isShown && (this.length ? this.viewed && (0 <= (s = e.indexOf(this.index)) ? (this.viewed = !1, this.view(Math.max(Math.min(this.index - s, this.length - 1), 0))) : (st(n = this.items[this.index], m), n.setAttribute("aria-selected", !0))) : (this.image = null, this.viewed = !1, this.index = 0, this.imageData = {}, this.canvas.innerHTML = "", this.title.innerHTML = ""))) : this.build()), this);
      },
      destroy: function destroy() {
        var t = this.element,
          e = this.options;
        return t[h] && (this.destroyed = !0, this.ready ? (this.played && this.stop(), e.inline ? (this.fulled && this.exit(), this.unbind()) : this.isShown ? (this.viewing && (this.imageRendering ? this.imageRendering.abort() : this.imageInitializing && this.imageInitializing.abort()), this.hiding && this.transitioning.abort(), this.hidden()) : this.showing && (this.transitioning.abort(), this.hidden()), this.ready = !1, this.viewer.parentNode.removeChild(this.viewer)) : e.inline && (this.delaying ? this.delaying.abort() : this.initializing && this.initializing.abort()), e.inline || ft(t, O, this.onStart), t[h] = void 0), this;
      }
    },
    St = {
      getImageURL: function getImageURL(t) {
        var e = this.options.url;
        return U(e) ? t.getAttribute(e) : Q(e) ? e.call(this, t) : "";
      },
      enforceFocus: function enforceFocus() {
        var t = this;
        this.clearEnforceFocus(), vt(document, R, this.onFocusin = function (e) {
          var i = t.viewer,
            n = e.target;
      ...
      clearEnforceFocus: function clearEnforceFocus() {
        this.onFocusin && (ft(document, R, this.onFocusin), this.onFocusin = null);
      },
      open: function open() {
        var t = this.body;
        st(t, S), 0 < this.scrollbarWidth && (t.style.paddingRight = "".concat(this.scrollbarWidth + (parseFloat(this.initialBodyComputedPaddingRight) || 0), "px"));
      },
      close: function close() {
        var t = this.body;
        at(t, S), 0 < this.scrollbarWidth && (t.style.paddingRight = this.initialBodyPaddingRight);
      },
      shown: function shown() {
        var t = this.element,
          e = this.options,
          i = this.viewer;
        this.fulled = !0, this.isShown = !0, this.render(), this.bind(), this.showing = !1, e.focus && (i.focus(), this.enforceFocus()), Q(e.shown) && vt(t, "shown", e.shown, {
          once: !0
        }), !1 !== pt(t, "shown") && this.ready && this.isShown && !this.hiding && this.view(this.index);
      },
      hidden: function hidden() {
        var t = this.element,
          e = this.options,
          i = this.viewer;
        e.fucus && this.clearEnforceFocus(), this.fulled = !1, this.viewed = !1, this.isShown = !1, this.close(), this.unbind(), st(i, w), i.removeAttribute("role"), i.removeAttribute("aria-labelledby"), i.removeAttribute("aria-modal"), i.setAttribute("aria-hidden", !0), this.resetList(), this.resetImage(), this.hiding = !1, this.destroyed || (Q(e.hidden) && vt(t, "hidden", e.hidden, {
          once: !0
        }), pt(t, "hidden", null, {
          cancelable: !1
        }));
      ...
      requestFullscreen: function requestFullscreen(t) {
        ...
        this.fulled && !(e.fullscreenElement || e.webkitFullscreenElement || e.mozFullScreenElement || e.msFullscreenElement) && ((e = e.documentElement).requestFullscreen ? J(t) ? e.requestFullscreen(t) : e.requestFullscreen() : e.webkitRequestFullscreen ? e.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT) : e.mozRequestFullScreen ? e.mozRequestFullScreen() : e.msRequestFullscreen && e.msRequestFullscreen());
      },
      ...
      change: function change(t) {
        ...
        if (o) {
          ...
          switch (this.action) {
            case c:
              0 == r && 0 == l || (this.pointerMoved = !0, this.move(r, l, t));
              break;
            case d:
              this.zoom((s = e({}, h = n), a = [], tt(h, function (t, e) {
                delete s[e], tt(s, function (e) {
                  var i = Math.abs(t.startX - e.startX),
                    n = Math.abs(t.startY - e.startY),
                    o = Math.abs(t.endX - e.endX);
                  e = Math.abs(t.endY - e.endY), i = Math.sqrt(i * i + n * n), n = Math.sqrt(o * o + e * e);
                  a.push((n - i) / i);
                });
              }), a.sort(function (t, e) {
            ...
            case u:
              ...
              var h = Math.abs(r);
              1 < h && h > Math.abs(l) && (this.pointers = {}, 1 < r ? this.prev(i.loop) : r < -1 && this.next(i.loop));
          }
          tt(n, function (t) {
  ...
  a = function () {
    function t(e) {
      ...
      if (!e || 1 !== e.nodeType) throw new Error("The first argument is required and must be an element.");
      this.element = e, this.options = et({}, s, J(i) && i), this.action = !1, this.fading = !1, this.fulled = !1, this.hiding = !1, this.imageClicked = !1, this.imageData = {}, this.index = this.options.initialViewIndex, this.isImg = !1, this.isShown = !1, this.length = 0, this.moving = !1, this.played = !1, this.playing = !1, this.pointers = {}, this.ready = !1, this.rotating = !1, this.scaling = !1, this.showing = !1, this.timeout = !1, this.tooltipping = !1, this.viewed = !1, this.viewing = !1, this.wheeling = !1, this.zooming = !1, this.pointerMoved = !1, this.id = At(), this.init();
    }
    var e, i, o;
    return e = t, o = [{
      key: "noConflict",
      value: function value() {
        return window.Viewer = It, t;
      }
    }, {
      key: "setDefaults",
      ...
      value: function value() {
        var t,
          ...
          s = this.element,
          a = this.options;
        s[h] || (s[h] = this, a.focus && !a.keyboard && (a.focus = !1), t = "img" === s.localName, e = [], tt(t ? [s] : s.querySelectorAll("img"), function (t) {
          Q(a.filter) ? a.filter.call(o, t) && e.push(t) : o.getImageURL(t) && e.push(t);
        }), this.isImg = t, this.length = e.length, this.images = e, this.initBody(), $(document.createElement(h).style.transition) && (a.transition = !1), a.inline ? (i = 0, n = function n() {
          var t;
          ...
          abort: function abort() {
            tt(e, function (t) {
              t.complete || (ft(t, F, n), ft(t, N, n));
            });
          }
        }, tt(e, function (t) {
          var e, i;
          t.complete ? n() : (vt(t, F, e = function e() {
            ft(t, N, i), n();
          }, {
            once: !0
          }), vt(t, N, i = function i() {
        ...
        })) : vt(s, O, this.onStart = function (t) {
          "img" !== (t = t.target).localName || Q(a.filter) && !a.filter.call(o, t) || o.view(o.images.indexOf(t));
        }));
      }
    }, {
      key: "build",
      value: function value() {
        var t, e, i, n, o, s, a, r, l, c, u, d, m, b;
        this.ready || (t = this.element, e = this.options, i = t.parentNode, (m = document.createElement("div")).innerHTML = '<div class="viewer-container" tabindex="-1" touch-action="none"><div class="viewer-canvas"></div><div class="viewer-footer"><div class="viewer-title"></div><div class="viewer-toolbar"></div><div class="viewer-navbar"><ul class="viewer-list" role="navigation"></ul></div></div><div class="viewer-tooltip" role="alert" aria-hidden="true"></div><div class="viewer-button" data-viewer-action="mix" role="button"></div><div class="viewer-player"></div></div>', m = (n = m.querySelector(".".concat(h, "-container"))).querySelector(".".concat(h, "-title")), o = n.querySelector(".".concat(h, "-toolbar")), b = n.querySelector(".".concat(h, "-navbar")), s = n.querySelector(".".concat(h, "-button")), a = n.querySelector(".".concat(h, "-canvas")), this.parent = i, this.viewer = n, this.title = m, this.toolbar = o, this.navbar = b, this.button = s, this.canvas = a, this.footer = n.querySelector(".".concat(h, "-footer")), this.tooltipBox = n.querySelector(".".concat(h, "-tooltip")), this.player = n.querySelector(".".concat(h, "-player")), this.list = n.querySelector(".".concat(h, "-list")), n.id = "".concat(h).concat(this.id), m.id = "".concat(h, "Title").concat(this.id), st(m, e.title ? xt(Array.isArray(e.title) ? e.title[0] : e.title) : w), st(b, e.navbar ? xt(e.navbar) : w), rt(s, w, !e.button), e.keyboard && s.setAttribute("tabindex", 0), e.backdrop && (st(n, "".concat(h, "-backdrop")), e.inline || "static" === e.backdrop || ut(a, H, "hide")), U(e.className) && e.className && e.className.split(B).forEach(function (t) {
          st(n, t);
        }), e.toolbar ? (r = document.createElement("ul"), l = J(e.toolbar), c = V.slice(0, 3), u = V.slice(7, 9), d = V.slice(9), l || st(o, xt(e.toolbar)), tt(l ? e.toolbar : V, function (t, i) {
          var n,
            o = l && J(t),
            s = (i = l ? ht(i) : t, o && !$(t.show) ? t.show : t);
          !s || !e.zoomable && -1 !== c.indexOf(i) || !e.rotatable && -1 !== u.indexOf(i) || !e.scalable && -1 !== d.indexOf(i) || (n = o && !$(t.size) ? t.size : t, o = o && !$(t.click) ? t.click : t, t = document.createElement("li"), e.keyboard && t.setAttribute("tabindex", 0), t.setAttribute("role", "button"), st(t, "".concat(h, "-").concat(i)), Q(o) || ut(t, H, i), Z(s) && st(t, xt(s)), -1 !== ["small", "large"].indexOf(n) ? st(t, "".concat(h, "-").concat(n)) : "play" === i && st(t, "".concat(h, "-large")), Q(o) && vt(t, O, o), r.appendChild(t));
        }), o.appendChild(r)) : st(o, w), e.rotatable || (st(m = o.querySelectorAll('li[class*="rotate"]'), T), tt(m, function (t) {
          o.appendChild(t);
        })), e.inline ? (st(s, p), nt(n, {
          zIndex: e.zIndexInline
        }), "static" === window.getComputedStyle(i).position && nt(i, {
          position: "relative"
        }), i.insertBefore(n, t.nextSibling)) : (st(s, g), st(n, v), st(n, f), st(n, w), nt(n, {
          zIndex: e.zIndex
        }), (b = (b = U(b = e.container) ? t.ownerDocument.querySelector(b) : b) || this.body).appendChild(n)), e.inline && (this.render(), this.bind(), this.isShown = !0), this.ready = !0, Q(e.ready) && vt(t, "ready", e.ready, {
          once: !0
        }), !1 === pt(t, "ready") ? this.ready = !1 : this.ready && e.inline && this.view(this.index));
      }
    }]) && n(e.prototype, i), o && n(e, o), Object.defineProperty(e, "prototype", {
      writable: !1
    }), t;
  }();
  return et(a.prototype, l, Tt, Et, Dt, St), a;
});
"use strict";
...
var swiper = new Swiper(".banner-home .swiper", {
  ...
  swiper3 = new Swiper(".banner-kartochka .swiper", {
    loop: !1,
    spaceBetween: 10,
    slidesPerView: "auto",
    direction: "horizontal",
    scrollbar: {
      el: ".banner-kartochka .swiper-scrollbar"
    },
    breakpoints: {
      200: {
        slidesPerView: "auto",
  ...
  swiper4 = new Swiper(".gal-video .swiper", {
    loop: !1,
    spaceBetween: 20,
    slidesPerView: "auto",
    direction: "horizontal",
    navigation: {
      nextEl: ".gal-video .swiper-button-next",
      prevEl: ".gal-video .swiper-button-prev"
    }
  }),
  swiper5 = new Swiper(".primer-marshrutov .swiper", {
    loop: !1,
    spaceBetween: 40,
    slidesPerView: "auto",
    direction: "horizontal",
    navigation: {
      nextEl: ".primer-marshrutov .swiper-button-next",
      prevEl: ".primer-marshrutov .swiper-button-prev"
    },
    breakpoints: {
      300: {
        slidesPerView: "auto",
  ...
  swiper6 = new Swiper(".otz-gal .swiper", {
    loop: !1,
    spaceBetween: 10,
    slidesPerView: "auto",
    direction: "horizontal",
    scrollbar: {
      el: ".otz-gal .swiper-scrollbar"
    },
    breakpoints: {
      200: {
        slidesPerView: "auto",
...
!function (e) {
  "function" != typeof e.matches && (e.matches = e.msMatchesSelector || e.mozMatchesSelector || e.webkitMatchesSelector || function (e) {
    for (var t = this, s = (t.document || t.ownerDocument).querySelectorAll(e), i = 0; s[i] && s[i] !== t;) ++i;
    return Boolean(s[i]);
...
}(window.Element.prototype), document.addEventListener("DOMContentLoaded", function () {
  ...
  e.forEach(function (e) {
    e.addEventListener("click", function (e) {
      ...
      document.querySelector('.modal[data-modal="' + s + '"]').classList.add("active"), t.classList.add("active");
    });
  }), s.forEach(function (e) {
    e.addEventListener("click", function (e) {
    ...
    27 == e.keyCode && (document.querySelector(".modal.active").classList.remove("active"), document.querySelector(".overlay").classList.remove("active"));
...
var Tabs = /*#__PURE__*/function () {
  function Tabs(e) {
    ...
    this.navItems = t.querySelectorAll(":scope > *"), this.listItems = s.querySelectorAll(":scope > *");
  }
  _createClass(Tabs, [{
    key: "init",
    value: function init() {
      ...
      for (var e = 0; e < this.navItems.length; e++) {
        ...
        this.active && t.classList.contains("active") && (this.isActive = e), t.classList.remove("active"), t.dataset.index = e;
      }
      this.listItems.forEach(function (e) {
        return e.classList.remove("active");
      }), this.active || (this.isActive = 0), this.toggle(this.isActive), this.navItems.forEach(function (e) {
    ...
    value: function toggle(e) {
      this.navItems[this.isActive].classList.remove("active"), this.listItems[this.isActive].classList.remove("active"), this.isActive = e, this.navItems[this.isActive].classList.add("active"), this.listItems[this.isActive].classList.add("active");
    }
  }]);
  return Tabs;
}();
...
function openMansoryBlocks(e, t, s) {
  var i = e.querySelectorAll(".cont-tury .block:not(.show)");
...
mansoryTabs.forEach(function (e) {
  ...
  var s = 6;
  document.body.clientWidth < 1200 && (s = 4), document.body.clientWidth < 767 && (s = 3), openMansoryBlocks(e, s, t), t.addEventListener("click", function () {
...
list.forEach(function (e) {
  var t = e.querySelector(".otz .btns button"),
    ...
    i = e.querySelector(".otz .text");
  t.addEventListener("click", function () {
    t.classList.toggle("active"), i.classList.toggle("text--full"), "Свернуть отзыв" === s.innerHTML ? s.innerHTML = "Раскрыть отзыв" : s.innerHTML = "Свернуть отзыв";
  });
});
var gal1 = document.querySelector(".banner-kartochka .swiper ");
if (gal1) {
  new Viewer(gal1);
}
var gal2 = document.querySelector(".gal-block ");
if (gal2) {
  new Viewer(gal2);
}
var gal3 = document.querySelector(".gal-video ");
if (gal3) {
  new Viewer(gal3);
}
var gal4 = document.querySelector(".otz-gal .slider");
if (gal4) {
  new Viewer(gal4);
}
...
var list2 = document.querySelectorAll(".sort-bl");
list2.forEach(function (e) {
  var t = e.querySelector(".sort-bl__name"),
    s = e.querySelector(".sort-bl__cont");
  t.addEventListener("click", function () {
    e.classList.toggle("active"), s.classList.toggle("active");
  });
});
var btn = document.querySelector(".tgl_btn"),
  hiddenTxt = document.querySelector(".togle_txt__hidden");
hiddenTxt && (hiddenTxt.style.display = "none", btn.addEventListener("click", function () {
  "block" == hiddenTxt.style.display ? (hiddenTxt.style.display = "none", btn.innerHTML = "Развернуть") : (hiddenTxt.style.display = "block", btn.innerHTML = "Свернуть");
})), document.querySelectorAll(".quantity_inner .bt_minus").forEach(function (e) {
  e.addEventListener("click", function (e) {
    e.preventDefault();
    var t = this.parentElement.querySelector(".quantity"),
      s = parseInt(t.value) - 1;
    s = s < 1 ? 1 : s, t.value = s;
  });
}), document.querySelectorAll(".quantity_inner .bt_plus").forEach(function (e) {
  e.addEventListener("click", function (e) {
    e.preventDefault();
    var t = this.parentElement.querySelector(".quantity"),
      s = parseInt(t.value) + 1;
    s = s > parseInt(t.dataset.maxCount) ? parseInt(t.dataset.maxCount) : s, t.value = parseInt(s);
  });
}), document.querySelectorAll(".quantity_inner .quantity").forEach(function (e) {
  e.addEventListener("change", function (e) {
    e.preventDefault(), this.value.match(/[^0-9]/g) && (this.value = this.value.replace(/[^0-9]/g, "")), "" == this.value && (this.value = 1), this.value > parseInt(this.dataset.maxCount) && (this.value = parseInt(this.dataset.maxCount));
  });
});
var linkUrl = document.querySelectorAll(".sb-menu a");
linkUrl.forEach(function (e) {
  var t = e.getAttribute("href");
  document.location.pathname == t && e.classList.add("active");
});
var btnFil = document.querySelector(".fil-btn"),
  fil = document.querySelector(".sort-sp-block"),
  closeFil = document.querySelector(".close-filter");
btnFil && btnFil.addEventListener("click", function () {
  fil.classList.toggle("active"), body.classList.toggle("no_scroll");
}), closeFil && closeFil.addEventListener("click", function () {
  fil.classList.remove("active"), body.classList.remove("no_scroll");
});
var list3 = document.querySelectorAll(".ind-tour .bl");
list3.forEach(function (e) {
  var t = e.querySelector(".tipa-select"),
    s = e.querySelector(".checkbox-block");
